import { getAuthToken as getToken, setAuthCookie, clearAuthCookie } from '@/lib/api/auth'
...
export async function deleteArchive(archiveId: string) {
    return apiRequest(`/api/user/archive?id=${archiveId}`, null, 'DELETE');
}
...
export async function leaveGuild() {
    return apiRequest('/api/guild/leave', null, 'POST');
}
